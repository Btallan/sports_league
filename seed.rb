...
def seed
    ...
    team3 = Team.new("Hawks","Illawarra","WIN Entertainment Centre","Red", team3_players, coach3, team3_staff)
    team4 = Team.new("Bullets","Brisbane","Nissan Arena","Red", team4_players, coach4, team4_staff)
...
# p1 = Player.new("Ben Allan", 1, "Mid-Field")
# c1 = Coach.new("Mr Coach")
# s1 = Staff.new("Lois Alexander", "Physio")
